...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document
    .getElementById('editSheetForm')
    ?.addEventListener('submit', handleUpdateSheet);
...
function populateForm(dto) {
  ...
  document.getElementById('cs-class-level').value = `${
    dto.primaryClass || ''
  } ${dto.primaryLevel || ''}`;
  ...
  document.getElementById('cs-skill-acrobatics').checked =
    dto.acrobaticsSkillProficiency;
  document.getElementById('cs-skill-animal').checked =
    dto.animalHandlingSkillProficiency;
  document.getElementById('cs-skill-arcana').checked =
    dto.arcanaSkillProficiency;
  document.getElementById('cs-skill-athletics').checked =
    dto.athleticsSkillProficiency;
  document.getElementById('cs-skill-deception').checked =
    dto.deceptionSkillProficiency;
  document.getElementById('cs-skill-history').checked =
    dto.historySkillProficiency;
  document.getElementById('cs-skill-insight').checked =
    dto.insightSkillProficiency;
  document.getElementById('cs-skill-intimidation').checked =
    dto.intimidationSkillProficiency;
  document.getElementById('cs-skill-investigation').checked =
    dto.investigationSkillProficiency;
  document.getElementById('cs-skill-medicine').checked =
    dto.medicineSkillProficiency;
  document.getElementById('cs-skill-nature').checked =
    dto.natureSkillProficiency;
  document.getElementById('cs-skill-perception').checked =
    dto.perceptionSkillProficiency;
  document.getElementById('cs-skill-performance').checked =
    dto.performanceSkillProficiency;
  document.getElementById('cs-skill-persuasion').checked =
    dto.persuasionSkillProficiency;
  document.getElementById('cs-skill-religion').checked =
    dto.religionSkillProficiency;
  document.getElementById('cs-skill-sleight').checked =
    dto.sleightOfHandSkillProficiency;
  document.getElementById('cs-skill-stealth').checked =
    dto.stealthSkillProficiency;
  document.getElementById('cs-skill-survival').checked =
    dto.survivalSkillProficiency;
...
async function handleUpdateSheet(event) {
  ...
  const classAndLevel = document
    .getElementById('cs-class-level')
    .value.split(' ');
  ...
  const dto = {
    ...
    constitution: parseInt(
      document.getElementById('cs-constitution').value,
      10
    ),
    intelligence: parseInt(
      document.getElementById('cs-intelligence').value,
      10
    ),
    ...
    // Col 1 - Skills (Checkboxes)
    acrobaticsSkillProficiency: document.getElementById('cs-skill-acrobatics')
      .checked,
    ...
    insightSkillProficiency:
      document.getElementById('cs-skill-insight').checked,
    intimidationSkillProficiency: document.getElementById(
      'cs-skill-intimidation'
    ).checked,
    investigationSkillProficiency: document.getElementById(
      'cs-skill-investigation'
    ).checked,
    medicineSkillProficiency:
      document.getElementById('cs-skill-medicine').checked,
    natureSkillProficiency: document.getElementById('cs-skill-nature').checked,
    perceptionSkillProficiency: document.getElementById('cs-skill-perception')
      .checked,
    performanceSkillProficiency: document.getElementById('cs-skill-performance')
      .checked,
    persuasionSkillProficiency: document.getElementById('cs-skill-persuasion')
      .checked,
    ...
    currentHitPoints: parseInt(
      document.getElementById('cs-current-hp').value,
      10
    ),
    temporaryHitPoints: parseInt(
      document.getElementById('cs-temp-hp').value,
      10
    ),
  ...
  const data = await apiCall(
    `/api/player/sheets/${currentSheetId}`,
    'PUT',
    dto
  );
