import { isAuthenticated, getCurrentUserFromStorage, hasRole, clearLoginData } from './auth.js';
...
export function checkPageAccess() {
    ...
    if (currentPage in pagePermissions) {
        ...
        if (requiredRole && !hasRole(requiredRole)) {
            console.warn(`Accesso negato a ${currentPage}: ruolo ${requiredRole} richiesto`);
            showAccessDenied();
            return false;
        }
